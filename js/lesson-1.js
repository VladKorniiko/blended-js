...
// const num = prompt("Введіть від 1 до 4:");
// let result = "";
// switch (num) {
//   case 1:
//     result = "зима";
...
// function formateTime(userMinutes) {
...
//   return a < b ? a : b;
// }
// console.log(min("DS", 11));
// console.log(min(15, 11));
// console.log(min(1, 11));
// console.log(min(23, 11));
...
// console.log(`Сумма четных чисел ${sum}`);
// // -------------------------------------------------------------------------
// let a = Number.parseInt(prompt("Введите число"));
// while (a <= 0) {
//   alert("Введите положительное число");
//   a = Number.parseInt(prompt("Введите число"));
// }
// for (let i = 1; i <= a; i++) {
//   if (i % 3 === 0) {
//     console.log(i);
...
while (isNaN(a) || a <= 0) {
  // Проверяем, является ли ввод числом и числом больше 0
  alert("Пожалуйста, введите положительное число.");
  a = prompt("Введите число");
}

a = Number.parseInt(a); // Преобразуем строку в число после проверки

let i = 2; // Начинаем с первого четного числа
while (i <= a) {
  sum += i;
  i += 2; // Переходим ко следующему четному числу
}
